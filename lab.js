...
// // let cat1 = new Cat ('Peppers', 2, 'grey')
// // console.log (cat1)
// // cat1.name 
...
// // let wizard1 = new Wizard ('Starlord', 169, 'WuTang Bow')
// // console.log (wizard1);
...
// //Code Here
// let phone1 = new Phone ('Apple', 'iPhone 10', 64, 'Black', 280)
// let phone2 = new Phone ('Samsung', 'Galaxy S10', 128, 'Black', 200)
// let phone3 = new Phone ('Samsung', 'Galaxy S9', 64, 'Grey', 120)
...
//Code Here
var myFirstVehicle = new Vehicle ('5 passengers', 'black', 600)
...
//Code Here 
var myFirstMotorcycle = new Motorcycle('KTM', true, '1 passenger', 'Black', 10)
...
class Boat extends Vehicle {
  constructor (make, isCool, capacity, color, mileage, name, type, isSeaworthy){
      super (capacity, color, mileage)
      this.name = name,
      this.type = type,
...
//Code Here
var myFirstBoat = new Boat('Hydra Sports', true, '10 passenger', 'Black', 15, 'StarLust', 'Sports yacht', false);
